...
var GLOSSARY = {
  ...
  '己': { category: '天干', definition: '阴土，田园之土，主包容、滋养、含蓄。',
    citations: [
      ...
      { book: '《穷通宝鉴》', chapter: '调候', text: '己土调候，以甲木疏土、丙火照暖、癸水滋润为要（戊己土共用甲丙癸）。' }
    ] },
  ...
  '癸': { category: '天干', definition: '阴水，雨露之水，主滋润、含蓄、细腻。',
    citations: [
      ...
      { book: '《穷通宝鉴》', chapter: '调候', text: '癸水调候，以庚辛金发源、戊土制水、丙火调候为要（壬癸水用戊辛丙）。' }
    ] },
  ...
  '子': { category: '地支', definition: '阳水，生肖鼠，子时（23–1 点），藏干癸。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '子十二支之魁，溪涧江洋之水，乃戊土旺地，一阳来复而后成旺。与午相冲，与卯相刑，与申辰三合会水局。' }] },
  '丑': { category: '地支', definition: '阴土，生肖牛，藏干己癸辛。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '丑虽隆冬，有冰霜之可怯，但天时已转二阳，丑中己土之暖能生万物，辛金养地。见戌则刑，见未则冲；见巳酉三合会金局。' }] },
  '寅': { category: '地支', definition: '阳木，生肖虎，藏干甲丙戊。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '寅建于春，气聚之阳，有丙火生焉。旺于卯，库于未，同类则为一家。至午则火光辉，而有超凡入圣之美。见申则寅受冲，而有破禄伤提之忧。' }] },
  '卯': { category: '地支', definition: '阴木，生肖兔，藏干乙。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '卯木仲春，气禀繁华，唱用金水，不可太过。见酉则冲，木必落叶；见亥未则合，木必成林。' }] },
  '辰': { category: '地支', definition: '阳土，生肖龙，藏干戊乙癸。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '辰建季春，为水泥之湿，而万物之根皆赖此培养。见戌为钥，能开库中之物。' }] },
  '巳': { category: '地支', definition: '阴火，生肖蛇，藏干丙戊庚。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '巳当初夏，其火增光，是六阳之极也。庚金寄生，戊土归禄。见申则刑，刑中有合；见亥则冲，冲而必破。' }] },
  '午': { category: '地支', definition: '阳火，生肖马，藏干丁己。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '午月炎火正，升入中气则一阴生也。庚至此为无用，己至此为归垣；见申子则必战克，见寅戌则越光明。' }] },
  '未': { category: '地支', definition: '阴土，生肖羊，藏干己丁乙。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '未当季夏，则阴深而火渐衰。未中有乙木，有丁火，是藏官、藏印，不藏财也。' }] },
  '申': { category: '地支', definition: '阳金，生肖猴，藏干庚壬戊。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '申宫水土长生之地，入巳午则逢火炼，遂成剑戟；见子辰则逢水淬，益得光锋。' }] },
  '酉': { category: '地支', definition: '阴金，生肖鸡，藏干辛。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '酉建八月金色，白水流清。若遇日时火多，运更愁东去。然逢己丑三合，亦能坚锐。' }] },
  '戌': { category: '地支', definition: '阳土，生肖狗，藏干戊辛丁。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '戌乃洪炉之库，钝铁顽金，赖以炼成。见辰龙则冲出壬水，而雨露生焉；见寅虎则会起丙火，而文章出焉。' }] },
  '亥': { category: '地支', definition: '阴水，生肖猪，藏干壬甲。',
    citations: [{ book: '《三命通会》', chapter: '论地支', text: '亥地六阴，雨雪载途，土至此而不暖，金至此而生寒。其象若五湖之归聚。' }] },
  ...
  '六合': { category: '合局', definition: '子丑合、寅亥合、卯戌合、辰酉合、巳申合、午未合，主亲近、和合。',
    citations: [{ book: '《三命通会》', chapter: '论支元六合', text: '夫合者，和也，乃阴阳相和，其气自合。是以一阴一阳和而谓之合。' }] },
  '三合': { category: '合局', definition: '申子辰合水、寅午戌合火、亥卯未合木、巳酉丑合金，主成局、聚气。',
    citations: [{ book: '《三命通会》', chapter: '论支元三合', text: '申子辰，申乃子之母，辰乃子之子，生旺库三者全，故申子辰为水局。若三字缺一则化不成局。' }] },
  ...
  '六冲': { category: '刑冲', definition: '子午、丑未、寅申、卯酉、辰戌、巳亥相冲，主动、散、冲突。',
    citations: [{ book: '《三命通会》', chapter: '论冲击', text: '地支取七位为冲，犹天干取七位为煞之义。相冲者，十二支战击之神，大概为凶。' }] },
  '六害': { category: '刑冲', definition: '子未、丑午、寅巳、卯辰、申亥、酉戌相害，主暗中妨害。',
    citations: [{ book: '《三命通会》', chapter: '论六害', text: '六害者，十二支凌战之辰也。' }] },
  '相刑': { category: '刑冲', definition: '寅巳申三刑、丑戌未三刑、子卯相刑、辰午酉亥自刑，主刑伤、是非。',
    citations: [{ book: '《三命通会》', chapter: '论三刑', text: '三刑生于二合，亦如六害生于六合之义。合中生刑，犹人夫妇相合而反致刑伤。' }] },
  ...
  '太极贵人': { category: '神煞', definition: '主福气、智慧、逢凶化吉。',
    citations: [{ book: '《三命通会》', chapter: '论太极贵', text: '太极者，太初也，始也，物造于初为太极，成也，收也，物有所归曰极。造化始终相保，乃曰太极贵也。' }] },
  '太极': { category: '神煞', definition: '即太极贵人，主福气、智慧、逢凶化吉。' },
  '文昌贵人': { category: '神煞', definition: '主学业、文才、科举功名。',
    citations: [{ book: '《三命通会》', chapter: '论文昌贵', text: '有文昌贵，甲乙蛇口乙猪头，丙狗丁龙戊向猴；己午庚寅辛未贵，六壬卯位癸逢牛。' }] },
  '文昌': { category: '神煞/星曜', definition: '主文才、学业、科举。八字为文昌贵人，紫微为文昌星。' },
  '羊刃': { category: '神煞', definition: '主刚烈、冲动、竞争、刑伤。',
    citations: [{ book: '《三命通会》', chapter: '论羊刃', text: '羊言刚也，刃者取宰割之义。禄过则刃生，越其分如羊之在刃，言有伤也。' }] },
  ...
  '桃花': { category: '神煞', definition: '又名咸池，主人缘、情缘、风流。',
    citations: [{ book: '《三命通会》', chapter: '论咸池', text: '五行沐浴之地，名咸池。一名败神，一名桃花煞，其神之奸邪淫鄙。' }] },
  '咸池': { category: '神煞', definition: '即桃花，主人缘、情缘、风流。' },
  '驿马': { category: '神煞', definition: '主奔波、远行、变动、迁徙。',
    citations: [{ book: '《三命通会》', chapter: '论驿马', text: '驿马者，三命中发用，喜庆之神。若人遇之，君子常居荣位，小人主丰赡。' }] },
  '将星': { category: '神煞', definition: '主领导、将才、掌权、威名。',
    citations: [{ book: '《三命通会》', chapter: '论将星华盖', text: '将星者，如将札中军也，故以三合中位谓之将星。' }] },
  '华盖': { category: '神煞', definition: '主孤独、艺术、宗教、玄学。',
    citations: [{ book: '《三命通会》', chapter: '论将星华盖', text: '华盖者，喻如宝盖，常覆乎大帝之座。凡人命得华盖，多主孤寡，总贵亦不免孤独，作僧道艺术论。' }] },
  '亡神': { category: '神煞', definition: '主灾祸、是非、暗昧。',
    citations: [{ book: '《三命通会》', chapter: '论劫煞亡神', text: '亡者，失也，自内失之之谓亡；亡在五行临官。' }] },
  '劫煞': { category: '神煞', definition: '主劫难、破财、刑伤。',
    citations: [{ book: '《三命通会》', chapter: '论劫煞亡神', text: '劫者，夺也，自外夺之之谓夺；劫在五行绝处。' }] },
  '红鸾': { category: '神煞', definition: '主婚姻、喜事、姻缘。' },
  '天喜': { category: '神煞', definition: '主喜庆、姻缘、添丁。',
    citations: [{ book: '《三命通会》', chapter: '论天喜', text: '天喜神，春戊，夏丑，秋辰、冬未，遇者主欢欣。' }] },
  '孤辰': { category: '神煞', definition: '主孤独、晚婚、独立。',
    citations: [{ book: '《三命通会》', chapter: '论孤辰寡宿', text: '老而无夫曰寡，幼而无父曰孤。人命犯此星辰，则孤寡如是。' }] },
  '寡宿': { category: '神煞', definition: '主寡居、孤独、清冷。',
    citations: [{ book: '《三命通会》', chapter: '论孤辰寡宿', text: '老而无夫曰寡，幼而无父曰孤。人命犯此星辰，则孤寡如是。' }] },
  '天德': { category: '神煞', definition: '主福德、贵气、逢凶化吉。',
    citations: [{ book: '《三命通会》', chapter: '论天月二德', text: '天德者，能回凶作善，乃曰天德也。' }] },
  '月德': { category: '神煞', definition: '主阴德、贵气、逢凶化吉。',
    citations: [{ book: '《三命通会》', chapter: '论天月二德', text: '月德者，乃三合所照之方，日月会合之辰。' }] },

  /* ---------- 紫微主星 ---------- */
  '紫微': { category: '紫微主星', definition: '帝星，主尊贵、领导、统御、尊严。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '紫微星，属己土，象阴，为南北斗中至尊至贵之星，故名帝座。专司官贵地位，掌造化之机枢，人生之主宰。' }] },
  '天机': { category: '紫微主星', definition: '主智谋、机变、筹划、善思。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '天机属乙木，象阴，南斗第三星，为智慧、益寿、仁善、谋划计算之星。' }] },
  '太阳': { category: '紫微主星', definition: '主光明、热情、父亲、女命夫星。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '太阳属丙火，象阳，中天第一主星，化气曰贵，日之精，为官禄主。' }] },
  '武曲': { category: '紫微主星', definition: '财星，主刚毅、决断、武将、财运。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '武曲属辛金，象阴，北斗第六星，化气为财，为财帛主，又名将星。' }] },
  '天同': { category: '紫微主星', definition: '福星，主安逸、随和、福气、享乐。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '天同属壬水，象阳，南斗第四星，化气为福，为福德主。' }] },
  '廉贞': { category: '紫微主星', definition: '次桃花星，主刚柔并济、司法、才华。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '廉贞属丁火，象阴，北斗第五星。' }] },
  '天府': { category: '紫微主星', definition: '库星，主包容、稳重、财库、领导。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '天府属戊土，象阳，南斗主第一星，在斗司权、号令之星，为帝座之佐，为田宅主，又名禄库。' }] },
  '太阴': { category: '紫微主星', definition: '主母亲、财帛、阴柔、细腻、女命夫星。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '太阴属癸水，象阴，中天第二主星，化气曰富，月之精，为财帛主、田宅主。' }] },
  '贪狼': { category: '紫微主星', definition: '桃花星，主欲望、多才、交际、开创。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '贪狼外属甲木，但根里属阴水，北斗第一星，化气为桃花，为第一桃花星，主祸福。' }] },
  '巨门': { category: '紫微主星', definition: '主口舌、是非、钻研、深究。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '巨门属癸水，属阴，北斗第二星，为阴精之星，化气为暗。' }] },
  '天相': { category: '紫微主星', definition: '印星，主辅佐、公正、协调、衣禄。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '天相属壬水，象阳，南斗第五星，化气为印，掌管官禄文星，主文书、印信、契约。' }] },
  '天梁': { category: '紫微主星', definition: '荫星，主老人、宗教、庇护、解难。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '天梁属戊土，象阳，南斗第二星，化气为荫，司寿禄，父母宫主，是父母星、老人星、医药星。' }] },
  '七杀': { category: '紫微主星', definition: '主肃杀、威权、将星、魄力。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '七杀属庚金，属阳，又属火，意为火化之金，南斗第六星。' }] },
  '破军': { category: '紫微主星', definition: '主破旧立新、变动、开创、消耗。',
    citations: [{ book: '《紫微斗数精成》', chapter: '星性', text: '破军属癸水，属阴，北斗第七星。' }] },

  /* ---------- 紫微辅星 ---------- */
  '文曲': { category: '紫微辅星', definition: '属癸水，主才艺、口才、文采、机巧。' },
  '左辅': { category: '紫微辅星', definition: '属戊土，主辅助、助力、贵人、扶持。' },
  '右弼': { category: '紫微辅星', definition: '属癸水，主辅助、助力、贵人、隐助。' },
  '天魁': { category: '紫微辅星', definition: '属丙火，阳贵，主科甲、贵人、扶助。' },
  '天钺': { category: '紫微辅星', definition: '属丁火，阴贵，主科甲、贵人、扶助。' },
  '擎羊': { category: '紫微辅星', definition: '属金，煞星，主刑伤、冲动、竞争。' },
  '陀罗': { category: '紫微辅星', definition: '属金，煞星，主拖延、是非、暗耗。' },
  '火星': { category: '紫微辅星', definition: '属火，煞星，主急躁、爆发、突然。' },
  '铃星': { category: '紫微辅星', definition: '属火，煞星，主暗耗、是非、抑郁。' },
  '地空': { category: '紫微辅星', definition: '属火，煞星，主空想、破财、飘忽。' },
  '地劫': { category: '紫微辅星', definition: '属火，煞星，主劫夺、破耗、起伏。' },
  '禄存': { category: '紫微辅星', definition: '属土，主财禄、衣禄、稳定财源。' },
  '天马': { category: '紫微辅星', definition: '属火，主奔波、远行、变动、活跃。' },
